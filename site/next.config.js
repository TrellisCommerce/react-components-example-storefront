...
const withTM = require('next-transpile-modules')(['@trelliscommerce/react-components']); // pass the modules you would like to see transpiled
...
module.exports = withCommerceConfig(withTM({
  commerce,
  i18n: {
    locales: ['en-US', 'es'],
    defaultLocale: 'en-US',
